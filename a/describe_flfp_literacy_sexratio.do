...
binscatter count_f_share_1990 total_literacy_91, linetype(connect) title(1990) xtitle(Total Literacy Rate) ytitle(Female Ownership Share) name(count_f_share_1990, replace)
...
graph combine count_f_share_1990 count_f_share_1998 count_f_share_2005 count_f_share_2013, xcommon ycommon title(Female Ownership Share vs. Total Literacy Rate)
graphout count_f_share_t_literacy

binscatter emp_f_owner_share_1990 total_literacy_91, linetype(connect) title(1990) xtitle(Total Literacy Rate) ytitle(Employment in Female Owned Firm Share) name(emp_f_owner_share_1990, replace)
...
graph combine emp_f_owner_share_1990 emp_f_owner_share_1998 emp_f_owner_share_2005 emp_f_owner_share_2013, xcommon ycommon title(Employment in Female Owned Firm Share vs. Total Literacy Rate)
...
binscatter count_f_share_1990 female_literacy_91, linetype(connect) title(1990) xtitle(Female Literacy Rate) ytitle(Female Ownership Share) name(count_f_share_1990, replace)
...
graph combine count_f_share_1990 count_f_share_1998 count_f_share_2005 count_f_share_2013, xcommon ycommon title(Female Ownership Share vs. Female Literacy Rate)
graphout count_f_share_f_literacy

binscatter emp_f_owner_share_1990 female_literacy_91, linetype(connect) title(1990) xtitle(Female Literacy Rate) ytitle(Employment in Female Owned Firm Share) name(emp_f_owner_share_1990, replace)
...
graph combine emp_f_owner_share_1990 emp_f_owner_share_1998 emp_f_owner_share_2005 emp_f_owner_share_2013, xcommon ycommon title(Employment in Female Owned Firm Share vs. Female Literacy Rate)
...
binscatter count_f_share_1990 sex_ratio_91, linetype(connect) title(1990) xtitle(Sex Ratio) ytitle(Female Ownership Share) name(count_f_share_1990, replace)
...
graph combine count_f_share_1990 count_f_share_1998 count_f_share_2005 count_f_share_2013, xcommon ycommon title(Female Ownership Share vs. Sex Ratio)
graphout count_f_share_ratio

binscatter emp_f_owner_share_1990 sex_ratio_91, linetype(connect) title(1990) xtitle(Sex Ratio) ytitle(Employment in Female Owned Firm Share) name(emp_f_owner_share_1990, replace)
...
graph combine emp_f_owner_share_1990 emp_f_owner_share_1998 emp_f_owner_share_2005 emp_f_owner_share_2013, xcommon ycommon title(Employment in Female Owned Firm Share vs. Sex Ratio)
