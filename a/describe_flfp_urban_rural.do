...
gr export $graphs/totempfshare.png, replace as (png)
...
gr export $graphs/empfshare.png, replace as (png)
...
graph export $graphs/empfsharecombine.png, replace as (png)
...
graph export $graphs/countfsharecombine.png, replace as (png)
...
graph export $graphs/empfownersharecombine.png, replace as (png)
