...
\begin{frame}{Clean Data}
  \begin{itemize}
    \item \textbf{PC sex ratios}: District\-wise sex ratios (urban areas only)
     ...
     \item \textbf{SECC district sex ratios by 5 yr age bins}: Currently saved in scratch folders of Aditi and Becky as \textcolor{blue}{secc\_sexratios\_age\_district}.
     \item \textbf{SECC sub\-district sex ratios by 5 yr age bins}: Currently saved in scratch folders of Aditi and Becky as \textcolor{blue}{secc\_sexratios\_age\_subdistrict}.
...
\centering
    ...
    \end{figure}
    \begin{figure}
          \includegraphics[scale=0.8]{\pngpath/r_15_20}
    \end{figure}
    }
\end{frame}
\end{section}
...
\begin{frame}{Replication in the Indian context using SECC
  ...
  \centering
    \resizebox{0.8\linewidth}{!}{
    \begin{figure}
          \includegraphics[scale=0.8]{\pngpath/replication}
    \end{figure}
    }
  \end{frame}
\end{section}
