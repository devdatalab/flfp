...
foreach var in 2002 2003 2004 2005 2006 2007 2008 2009 2010 2011 2012 {
 gen var`var'`x' = enr_all_`x' if year == `var'
...
gr save $tmp/`var'_`x'.gph, replace
}
}
...
foreach x in g b {
gr combine $tmp/ln_avg0203_`x'.gph $tmp/ln_avg0406_`x'.gph $tmp/ln_avg0709_`x'.gph $tmp/ln_avg1012_`x'.gph, ///
title(Reduced Form - Average Primary Enrollment for `x') ycommon xcommon
graphout reduced_enr_`x'
}
