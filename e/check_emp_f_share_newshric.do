...
// Gen predicted female employment and residuals
...
outsheet shric shric_desc empfgrowth fshare_growth empfpredicted empfresidual using $tmp/testlist.csv if year == 2013, comma
