...
/* remove numbers and parentheses from district names */
...
/*process_manual_matches, outfile(/scratch/plindsay/kgbv_manual.csv) ///
    infile(/scratch/plindsay/unmatched_observations_105680.csv) ///
    s1(pc01_block_name) idmaster(id_master) idusing(id_using)
*/

/* open merge results */
use /scratch/plindsay/merge_results_105680, clear

/* insert manually processed matches into master dataset */
insert_manual_matches, manual_file($tmp/kgbv_manual.csv) ///
